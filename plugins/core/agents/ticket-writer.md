...
name: ticket-writer
model: sonnet
description: Use this agent to write end-of-work documentation tickets. Spawned by build commands during the documentation phase. Documents what was actually built, decisions made, deviations from plan, and known follow-ups.
---
